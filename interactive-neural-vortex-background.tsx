  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        color = vec3(0.05, 0.45, 0.35);
        color = mix(color, vec3(0.0, 0.75, 0.65), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.0, 0.3, 0.25) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
