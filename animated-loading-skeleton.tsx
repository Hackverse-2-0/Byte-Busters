...
const AnimatedLoadingSkeleton = () => {
    ...
    return (
        <div className="flex items-center justify-center w-full min-h-[500px] p-4">
            <motion.div
                className="relative w-full max-w-3xl bg-card rounded-2xl border border-border shadow-lg overflow-hidden p-6"
            ...
            >
                ...
                >
                    {[...Array(config.numCards)].map((_, i) => (
                        <motion.div
                            key={i}
                            className="rounded-xl border border-border bg-muted/50 p-4 space-y-3"
